								...
								<div class="main-left-sidebar">
									<div class="user_profile">
										<div class="user-pro-img">
											<img height="150px" width="150px" src="{{ Auth::user()->image }}"alt="profile image">
								...
								<div class="main-ws-sec">
									<div class="user-tab-sec">
										...
										<div class="star-descp">
											<span>{{ Auth::user()->designation }}
													at
												{{ Auth::user()->organisation  }}</span>
											<ul>
									...
									<div class="product-feed-tab" id="info-dd">
										<div class="user-profile-ov">
											<h3>Overview <button class="btn btn-sm btn-light float-right waves-effect waves-float" type="button" data-toggle="modal" data-target="#overviewModal"><i class="fas fa-pencil-alt mr-2"></i>Edit</button></h3>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tempor aliquam felis, nec condimentum ipsum commodo id. Vivamus sit amet augue nec urna efficitur tincidunt. Vivamus consectetur aliquam lectus commodo viverra. Nunc eu augue nec arcu efficitur faucibus. Aliquam accumsan ac magna convallis bibendum. Quisque laoreet augue eget augue fermentum scelerisque. Vivamus dignissim mollis est dictum blandit. Nam porta auctor neque sed congue. Nullam rutrum eget ex at maximus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eget vestibulum lorem.</p>
										</div><!--user-profile-ov end-->
										<div class="user-profile-ov st2">
											<h3>Experience <button class="btn btn-sm btn-light float-right waves-effect waves-float" type="button" data-toggle="modal" data-target="#ExperienceModal"><i class="fas fa-pencil-alt mr-2"></i>Edit</button></h3>
											<h4>Web designer</h4>
										...
										<div class="user-profile-ov">
											<h3>Education <button class="btn btn-sm btn-light float-right waves-effect waves-float" type="button" data-toggle="modal" data-target="#EducationModal"><i class="fas fa-pencil-alt mr-2"></i>Edit</button></h3>
											<h4>Master of Computer Science</h4>
											<span>2015 - 2017</span>
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tempor aliquam felis, nec condimentum ipsum commodo id. Vivamus sit amet augue nec urna efficitur tincidunt. Vivamus consectetur aliquam lectus commodo viverra. </p>
										</div><!--user-profile-ov end-->
										<div class="user-profile-ov">
											<h3>Location <button id="btnGroupDrop1" type="button" class="btn btn-secondary float-right dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Edit</button>
										    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
										      <a href="" class="dropdown-item btn btn-sm btn-light waves-effect waves-float" type="button" data-toggle="modal" data-target="#locationModal"><i class="fas fa-pencil-alt mr-2"></i>Permanent Address</a>
										      <a href="" class="dropdown-item btn btn-sm btn-light waves-effect waves-float" type="button" data-toggle="modal" data-target="#current_addressModal"><i class="fas fa-pencil-alt mr-2"></i>Current Address</a>
										    </div> </h3>
											...
											<div class="user-profile-ov">
											<h3>Personal Information <button class="btn btn-sm btn-light float-right waves-effect waves-float" type="button" data-toggle="modal" data-target="#InformationModal"><i class="fas fa-pencil-alt mr-2"></i>Edit</button></h3>
											<h4>Email Address</h4>
										...
										<div class="user-profile-ov">
											<h3>Skills <button class="btn btn-sm btn-light float-right waves-effect waves-float" type="button" data-toggle="modal" data-target="#SkillsModal"><i class="fas fa-pencil-alt mr-2"></i>Edit</button></h3>
											<ul>
